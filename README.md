...
│   └── 02_eda_banking.ipynb  (coming soon)
│
├── 02_nlp/
│   ├── 03_nlp_text_classification_banking.ipynb
│   └── 04_hugging_face_intro_banking.ipynb
│
├── 03_llm_and_genai/
...
| 02 | EDA — Banking Dataset | Exploratory data analysis with financial data | pandas, seaborn, matplotlib | ✅ Yes |
| 03 | NLP Text Classification | Classifying customer emails with TF-IDF and transformers | scikit-learn, Hugging Face | ✅ Yes |
| 04 | Hugging Face Introduction | Sentiment, NER, summarisation, zero-shot classification | transformers, torch | ✅ Yes |
...
```bash
git clone https://github.com/gabrielajuncosa/banking-ai-portfolio
cd banking-ai-portfolio
